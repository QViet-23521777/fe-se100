...
export default function AdminAccountsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070f2b] text-white -mx-5 sm:-mx-10">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-5 pb-16 pt-8 sm:px-8 lg:px-10">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-white/10 bg-[#0c143d]/70 p-6 shadow-xl">
            ...
            <form className="space-y-3" onSubmit={createAdmin}>
              ...
              <input className="input" name="username" placeholder="Username (optional)" value={adminForm.username} onChange={handleAdmChange} />
              <input className="input" name="role" placeholder="Role (e.g., manager)" value={adminForm.role} onChange={handleAdmChange} />
              {admMsg ? (
